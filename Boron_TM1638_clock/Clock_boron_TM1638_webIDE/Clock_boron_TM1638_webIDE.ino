...
#include "Particle.h"
/*
* Project test: Clock Boron TM1638
* Description:
* Author:Ben Dash
* Date:
*/
...
{   
    ...
    {
        flag = FALSE;
        Get_Time(backupVariables.timeFormat); // Get updated time in EST
        Show_Time(); // Show the updated time
    }
}
...
void Set_TimeZone_EST(void)
{
    int estOffset = -5;    // EST offset from UTC
    Time.zone(estOffset);  // Set time zone to EST
}
